...
const Hero = ({ displayText }: Props) => {
  return (
    <>
      <figure className="mx-auto lg:px-0 px-8 md:my-20 mt-10 relative z-[1] max-w-full w-[50rem] h-[30rem] rounded-b-lg ">
        <div className="relative flex items-center max-w-[50rem] bg-gray-800 rounded-t-lg py-2 px-24 dark:bg-gray-700">
          ...
          <div className="flex justify-center items-center w-full h-full bg-gray-700 text-[.5rem] text-gray-400 rounded-sm sm:text-[.5rem] dark:bg-gray-600 dark:text-gray-400">{`https://${displayText}`}</div>
        </div>
        ...
        <div className="bg-gray-800 rounded-b-lg">
          ...
          >
            <img
              ...
              src={`${displayText === "github" ? "/github.png" : "/holo-app.png"}`}
