    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          ...
          <p><a className="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">Careers</a> <span className="inline px-2 py-1 ml-1 text-xs text-white bg-blue-700 rounded-md">We're hiring</span></p>
